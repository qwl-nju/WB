...
public class PicPro {
     ...
     */
         ...
         * @return Bitmap
         */
        public static Bitmap convert2RoundedCorner(Bitmap mBitmapSrc, float roundPx) {
         ...
         * @return Bitmap
         */
        public static Bitmap bitmap2Gray(Bitmap mBitmapSrc) {
            // 得到图片的长和宽
         ...
         * @return Bitmap
         */
        public static Bitmap bitmap2LineGrey(Bitmap mBitmapSrc) {
            // 得到图像的宽度和长度
            int width = mBitmapSrc.getWidth();
            int height = mBitmapSrc.getHeight();
            // 创建线性拉升灰度图像
         ...
         * @return Bitmap
         */
        public static Bitmap gray2Binary(Bitmap mBitmapSrc) {
            // 得到图形的宽度和长度
            int width = mBitmapSrc.getWidth();
            int height = mBitmapSrc.getHeight();
            // 创建二值化图像
    ...
    public static String gray2Binary2txt(Bitmap mBitmapSrc) {
...
//                binarybm.setPixel(i, j, newColor);
         ...
         * @return Bitmap
         */
        public static Bitmap convertToBlur(Bitmap mBitmapSrc) {
            // 高斯矩阵
         ...
         * @return Bitmap
         */
        public static Bitmap convertToSketch(Bitmap mBitmapSrc) {
            int pos, row, col, clr;
            int width = mBitmapSrc.getWidth();
            int height = mBitmapSrc.getHeight();
         ...
         * @return Bitmap
         */
        public static Bitmap oldRemeberImage(Bitmap mBitmapSrc) {
          /*
           * 怀旧处理算法即设置新的RGB
         ...
         * @return Bitmap
         */
        public static Bitmap sunshineImage(Bitmap mBitmapSrc, Position position, float strength) {
          /*
           * 算法原理：(前一个像素点RGB-当前像素点RGB+127)作为当前像素点RGB值
           * 在ABC中计算B点浮雕效果(RGB值在0~255)
           * B.r = C.r - B.r + 127
         ...
         * @return Bitmap
         */
        public static Bitmap iceImage(Bitmap mBitmapSrc) {
            int width = mBitmapSrc.getWidth();
            int height = mBitmapSrc.getHeight();
            Bitmap bitmap = Bitmap.createBitmap(width, height, Bitmap.Config.RGB_565);
            int pixColor = 0;
         ...
         * @return Bitmap
         */
        public static Bitmap zoomBitmap(Bitmap mBitmapSrc, int w, int h) {
            int width = mBitmapSrc.getWidth();
            int height = mBitmapSrc.getHeight();
         ...
         * @return Bitmap
         */
        public static Bitmap zoomBitmap(Bitmap mBitmapSrc, float widthScale, float heightScale) {
            Matrix matrix = new Matrix();
         ...
         * @return Bitmap
         */
        public  static Bitmap drawableToBitmap(Drawable mDrawableSrc) {
         ...
         * @return Bitmap
         */
        public  static Bitmap toReflectedImage(Bitmap mBitmapSrc) {
         ...
         * @return Bitmap
         */
        public static Bitmap createBitmapWithWatermark(Bitmap mBitmapSrc, Bitmap waterMarkSrc, Position position) {
            if (mBitmapSrc == null) {
                return null;
            }
         ...
         * @return Bitmap
         */
        public static Bitmap getThumbBitmap(Bitmap mBitmapSrc, int width, int height) {
         ...
         * @return Bitmap
         */
        public static Bitmap toBlackAndWhite(Bitmap mBitmapSrc) {
            int mBitmapWidth;
            int mBitmapHeight;
         ...
         * @return Bitmap
         */
        private static Bitmap negativeFilm(Bitmap mBitmapSrc) {
            // RGBA的最大值
         ...
         * @return Bitmap
         */
        public static Bitmap oilPainting(Bitmap mBitmapSrc) {
         ...
         * @return Bitmap
         */
        public static Bitmap photoMix(Position position, Bitmap... mBitmapSrcs) {
        ...
        private static Bitmap createBitmapForPhotoMix(Bitmap first, Bitmap second, Position position) {
            if (first == null) {
                return null;
            }
            if (second == null) {
         ...
         */
        public static void saveBitmap2File(Bitmap mBitmapSrc, String fileName, String filePath, Format format) {
            String suffix = "jpg";
